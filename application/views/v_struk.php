                                 ...
                                 <table id="penerima" width="100%" border="0">
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan="6"><input size="55" type="text" name="no_rek" id="no_rek"></td>
                                         </div>
                                     </tr>
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan="6"><input size="55" type="text" name="nama_bank" id="bank"></td>
                                         </div>
                                     </tr>
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan="6"><input size="55" type="text" name="address" id="address"></td>
                                         </div>
                                     </tr>
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan="6"><input size="55" type="text" name="jn" id="no_identitas"></td>
                                         </div>
                                     </tr>
                                 </table>
                             </div>
                                 ...
                                 <table border="1" width="100%">
                                     <div class="form-group">
                                         ...
                                         <tr>
                                             ...
                                             <td><input size="50" type="text" name="biaya_pengirim" id="biaya_pengirim"></td>
                                         </tr>
                                         <tr>
                                 ...
                                 <table border="0" width="100%">
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan="6"><input size="62" type="text" name="alamat2" id="alamat"></td>
                                         </div>
                                     </tr>
                                 </table>
                                 ...
                                 <table border="0" width="100%">
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan=""><input size="75" type="text" name="terbilang" id="terbilang"></td>
                                         </div>
                                     </tr>
                                 </table>
                                 <table>
                                 ...
                                 <table width="100%" border="0">
                                     <div class="form-group">
                                         ...
                                         <tr>
                                             ...
                                             <td colspan=""><input size="25" type="text" name="lain" id="isi_others"></td>
                                         </tr>
                                     </div>
                                 </table>
                             </div>
