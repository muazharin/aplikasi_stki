 ...
 <section class="content">
     ...
     <div class="container-fluid">
         <div class="card">
             ...
             <!-- /.card-header -->
             <div class="card-body">
                 <form action="<?= base_url('Cetak')  ?>" method="get" target="_blank">
                     <div class="row">
                         <div class="col-6">
                             ...
                             <div class="text-man">
                                 <table border="1" width="100%">
                                     <tr>
                                         ...
                                         <td width="30%" style="text-align: center;"><b>Nomor cek/BG</b><i> cheque number</i></td>
                 ...
                 <div class="row">
                     <div class="col">
                         <div class="float-right">
                             <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-print"></i> Print</button>
                         </div>
                     </div>
                 </div>
             </div>
