 ...
 <section class="content">
     ...
     <div class="container-fluid">
         <div class="card">
             ...
             <!-- /.card-header -->
             <div class="card-body">
                 <!-- <form action="<?= base_url('Cetak/printPDF')  ?>" target="_blank"> -->
                 <div class="row">
                     <div class="col-6">
                         ...
                         <div style="margin-bottom:-7px;"><b class="span_text text-man">kepada</b> to <b
                                 ...
                                 style="float: right;" class="text-man"><b>tanggal</b> <i>date</i><input type="date"
                         ...
                         <div class="text-man">
                             <table width="100%" border="0">
                                 <tr>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="perorang"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             perorangan</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                             id="perusahaan" name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             perusahaan</b><br>
                                         <div style="margin-top: -7px;"><i>company</i></div>
                                     </td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                             id="pemerintah" name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             pemerintah</b><br>
                                 ...
                                 <tr>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="penduduk"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             penduduk</b><br>
                         ...
                         <div class="text-man">
                             <table width="100%" border="0">
                                 <tr>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="tabungan"
                                             name="cb_1" /></td>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="pay"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text"
                                         style="vertical-align: middle; padding-left: 3px;"><b>
                                             Pembayaran</b><br>
                                 ...
                                 <tr>
                                     <td></td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="bisnis"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text"
                                         style="vertical-align: middle; padding-left: 3px;"><b>
                                             Bisnis</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                             id="pembeli_brg" name="cb_1" /></td>
                                     <td class="text-man up_mar span_text"
                                         style="vertical-align: middle; padding-left: 3px;"><b>
                                             Pembelian barang / jasa</b><br>
                                         <div style="margin-top: -7px;"><i>purchase of goods/services</i></div>
                                     </td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="donasi"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text"
                                         style="vertical-align: middle; padding-left: 3px;"><b>
                                             Donasi / amal</b><br>
                                 ...
                                 <tr>
                                     ...
                                     <td colspan="6"><input size="68" type="text" name="" id="brita_transaksi"></td>
                                 </tr>
                             </table>
                         </div>
                         ...
                         <div class="text-man">
                             <table border="1" width="100%">
                                 <tr>
                                     ...
                                     <td width="45%"><input size="50" type="text" name="" id="jml_transfer"></td>
                                 </tr>
                                 <tr>
                                     <td><b>Komisi</b><i> commission</i></td>
                                     <td><input size="50" type="text" name="" id="komisi"></td>
                                 </tr>
                                 <tr>
                                     <td><b>Biaya Pengiriman</b><i> transfer fee</i> <b>(SWIFT/RTGS/SKNBI)</b></td>
                                     <td><input size="50" type="text" name="" id="biaya_pengirim"></td>
                                 </tr>
                                 <tr>
                                     <td><b>Biaya Koresponden</b><i> correspondent charge</i></td>
                                     <td><input size="50" type="text" name="" id="biaya_kores"></td>
                                 </tr>
                                 <tr>
                                     <td><b>Sub Total</b></td>
                                     <td><input size="50" type="text" name="" id="sub_total"></td>
                                 </tr>
                                 <tr>
                                     <td><b>Kurs</b><i> rate</i></td>
                                     <td><input size="50" type="text" name="" id="rate"></td>
                                 </tr>
                                 <tr>
                                     <td><b>Total</b></td>
                                     <td><input size="50" type="text" name="" id="total"></td>
                                 </tr>
                             </table>
                         </div>
                         ...
                         <div class="text-man">
                             <table border="1" width="100%">
                                 ...
                                 <tr>
                                     <td></td>
                                     <td style="text-align: center;"><br><br><b>Nama</b><i> name </i><input type="text"
                                             size="26" name="" id="nama_pemohon"></td>
                                 </tr>
                             </table>
                         </div>
                     ...
                     <div class="col-6">
                         <div class="text-man">
                             <table border="0" width="100%">
                                 <tr>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="nasabah"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             nasabah</b><br>
                                 ...
                                 <tr>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="individu"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             perorangan</b><br>
                                         <div style="margin-top: -7px;"><i>individual</i></div>
                                     </td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="company"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             perusahaan</b><br>
                                         <div style="margin-top: -7px;"><i>company</i></div>
                                     </td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="gover"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             pemerintah</b><br>
                                         <div style="margin-top: -7px;"><i>government</i></div>
                                 ...
                                 <tr>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="resident"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             penduduk</b><br>
                                         <div style="margin-top: -7px;"><i>resident</i></div>
                                 ...
                                 <tr>
                                     ...
                                     <td colspan="6"><input size="62" type="text" name="" id="alamat"></td>
                                 </tr>
                             </table>
                         ...
                         <div class="text-man">
                             ...
                             <table width="100%" border="0">
                                 <tr>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="cash"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             &nbsp; tunai</b><br>
                                         <div style="margin-top: -7px;"><i>&nbsp;&nbsp;cash</i></div>
                                     </td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="debit"
                                             name="cb_1" /></td>
                                     &nbsp;
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             &nbsp;debet rekening:</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="cek_bil"
                                             name="cb_1" /></td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                         ...
                         <div class="text-man">
                             <table border="1" width="100%">
                                 ...
                                 <tr>
                                     <td><input size="30" type="text" name="" id="bank1"></td>
                                     <td><input size="30" type="text" name="" id="no_cek1"></td>
                                     <td><input size="12" type="text" name="" id="valuta1"></td>
                                     <td><input size="12" type="text" name="" id="nominal1"></td>
                                 </tr>
                                 <tr>
                                     <td><input size="30" type="text" name="" id="bank2"></td>
                                     <td><input size="30" type="text" name="" id="no_cek2"></td>
                         ...
                         <div class="text-man">
                             ...
                             <table width="100%" border="0">
                                 <tr>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="gaji"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="warisan"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Warisan</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="dana"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                 ...
                                 <tr>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="hadiah"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Hibah / hadiah</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="aset"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Penjualan aset</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                             id="hasil_usaha" name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Hasil usaha</b><br>
                                         <div style="margin-top: -7px;"><i>business proceed</i></div>
                                     </td>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="sumbangan"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Sumbangan</b><br>
                         ...
                         <div class="text-man">
                             ...
                             <table width="100%" border="0">
                                 <tr>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="tunai"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Tunai &nbsp;&nbsp;&nbsp;&nbsp;</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="deb_rek"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Debet rekening : &nbsp;&nbsp;&nbsp;&nbsp;</b><br>
                             ...
                             <table width="100%" border="0">
                                 <tr>
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="pengirim"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Pengirim &nbsp;&nbsp;&nbsp;&nbsp;</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="penerima"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Penerima &nbsp;&nbsp;&nbsp;&nbsp;</b><br>
                                     ...
                                     <td class="text-man" style="margin-top: 2px;"><input type="checkbox" id="others"
                                             name="cb_1" />&nbsp;
                                     </td>
                                     <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                             Lainnya &nbsp;&nbsp;&nbsp;&nbsp;</b><br>
                         ...
                         <div class="text-man">
                             <table border="0" width="100%">
                                 ...
                                 <tr>
                                     ...
                                     <td colspan=""><input size="55" type="text" name="" id="alamat_nonpengirim">
                                     </td>
                                 </tr>
                                 <tr>
                 ...
                 <div class="row">
                     <div class="col">
                         <div class="float-right">
                             <button id="btn_simpan" class="btn btn-primary btn-block"><i class="fa fa-print"></i>
                                 Simpan</button>
                         </div>
                     </div>
                 </div>
