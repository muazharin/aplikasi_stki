...
<html lang="en">
<?php
if ($this->session->userdata('userlog'))     // mencegah akses langsung tanpa login
{
    $users = $this->session->userdata('userlog');
        ...
        <aside class="main-sidebar sidebar-dark-mini elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?= base_url('Admin/data') ?>" class="d-block"><?= $this->session->userdata('userlog'); ?></a>
                    </div>
                </div>
