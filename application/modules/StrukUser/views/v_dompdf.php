...
vglayout;position:absolute;z-index:1;left:340px;top:12px;width:98px;height:
...
height:21px'><?= $data->no_rek ?></span>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span
                                    style='mso-ignore:vglayout;
position:absolute;z-index:1;left:190px;top:150px;width:22px;height:18px'><?= $data->penerima == "perorangan" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                            </p>
                            <p>
                                <!--[if gte vml 1]><v:rect
