 ...
 <section class="content">
     ...
     <div class="container-fluid">
         <div class="card">
             ...
             <form action="<?php echo base_url('StrukUser/simpan_struk') ?>" id="form" method="post">
                 <!-- /.card-header -->
                 <div class="card-body">
                     <div class="row">
                         <div class="col-6">
                             <div class="form-group">
                                 ...
                                 <div style="margin-bottom:-7px;"><b class="span_text text-man">kepada</b> to <b
                                         ...
                                         style="float: right;" class="text-man"><b>tanggal</b> <i>date</i><input
                                             type="date" class="" name="tgl" id="tgl"></span>
                                 </div>
                             </div>
                                 ...
                                 <table id="transaksi" width="100%" border="0" cellspacing="0" cellpadding="0">
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td class="text-man up_mar"><input type="checkbox" id="" name="transaksi[]"
                                                     value="4">
                                             </td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     SKNBI</b><br>
                                 ...
                                 <table id="penerima" width="100%" border="0">
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="perorang" name="penerima[]" value="perorangan" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     perorangan</b><br>
                                                 <div style="margin-top: -7px;"><i>individual</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="perusahaan" name="penerima[]" value="perusahaan" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     perusahaan</b><br>
                                                 <div style="margin-top: -7px;"><i>company</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="pemerintah" name="penerima[]" value="pemerintah" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     pemerintah</b><br>
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="penduduk" name="penduduk[]" value="penduduk" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     penduduk</b><br>
                                                 <div style="margin-top: -7px;"><i>resident</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="nonpenduduk" name="penduduk[]" value="bukan penduduk" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     bukan
                                                     penduduk</b><br>
                                 ...
                                 <table width="100%" border="0">
                                     <div class="form-group">
                                         ...
                                         <tr>
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="tabungan" name="tujuan[]" value="tabungan" /></td>
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="pay" name="tujuan[]" value="pembayaran" /></td>
                                             <td class="text-man up_mar span_text"
                                                 style="vertical-align: middle; padding-left: 3px;"><b>
                                                     Pembayaran</b><br>
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="biaya_hidup" name="tujuan[]" value="biaya hidup" /></td>
                                             <td class="text-man up_mar span_text"
                                                 style="vertical-align: middle; padding-left: 3px;"><b>
                                                     Biaya hidup</b><br>
                                         ...
                                         <tr>
                                             <td></td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="bisnis" name="tujuan[]" value="bisnis" /></td>
                                             <td class="text-man up_mar span_text"
                                                 style="vertical-align: middle; padding-left: 3px;"><b>
                                                     Bisnis</b><br>
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="pembeli_brg" name="tujuan[]" value="pembelian barang" /></td>
                                             <td class="text-man up_mar span_text"
                                                 style="vertical-align: middle; padding-left: 3px;"><b>
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="donasi" name="tujuan[]" value="donasi" /></td>
                                             <td class="text-man up_mar span_text"
                                                 style="vertical-align: middle; padding-left: 3px;"><b>
                                                     Donasi / amal</b><br>
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td colspan="6"><input size="68" type="text" name="brita"
                                 ...
                                 <table border="1" width="100%">
                                     <div class="form-group">
                                         ...
                                         <tr>
                                             ...
                                             <td width="45%"><input size="50" type="text" name="jml_trans"
                                                     id="jml_transfer"></td>
                                         </tr>
                                         <tr>
                                     ...
                                     <div class="form-group">
                                         ...
                                         <tr>
                                             ...
                                             <td style="text-align: center;"><br><br><b>Nama</b><i> name </i><input
                                                     type="text" size="26" name="ttd" id="nama_pemohon"></td>
                                         </tr>
                                     </div>
                                 </table>
                             </div>
                                 ...
                                 <table border="0" width="100%">
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="nasabah" name="pengirim[]" value="nasabah" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     nasabah</b><br>
                                                 <div style="margin-top: -7px;"><i>customer</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="nonnasabah" name="pengirim[]" value="non nasabah" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     non nasabah</b><br>
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="individu" name="info[]" value="perorangan" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     perorangan</b><br>
                                                 <div style="margin-top: -7px;"><i>individual</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="company" name="info[]" value="perusahaan" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     perusahaan</b><br>
                                                 <div style="margin-top: -7px;"><i>company</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="gover" name="info[]" value="pemerintah" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     pemerintah</b><br>
                                                 <div style="margin-top: -7px;"><i>government</i></div>
                                             </td>
                                     ...
                                     <tr>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="resident" name="status[]" value="penduduk" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     penduduk</b><br>
                                                 <div style="margin-top: -7px;"><i>resident</i></div>
                                             </td>
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="bkn_penduduk" name="status[]" value="bukan penduduk" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     bukan penduduk</b><br>
                                                 <div style="margin-top: -7px;"><i>non-resident</i></div>
                                             </td>
                                 ...
                                 <table width="100%" border="0">
                                     <tr>
                                         <div class="form-group">
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="debit" name="metode[]" value="debet" /></td>
                                             &nbsp;
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
                                                     &nbsp;debet rekening:</b><br>
                                             ...
                                             <td class="text-man" style="margin-top: 2px;"><input type="checkbox"
                                                     id="cek_bil" name="metode[]" value="cek" /></td>
                                             <td class="text-man up_mar span_text" style="vertical-align: text-top;"><b>
