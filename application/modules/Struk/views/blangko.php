...
$sql = "SELECT * FROM tb_struk WHERE id_struk=$id";
...
vglayout;position:absolute;z-index:1;left:530px;top:40px;width:98px;height:
15px'><?php echo date_format(date_create($data['tanggal']), 'd-m-Y'); ?></span>
 ...
 height:15pt;z-index:2'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:2;left:767px;top:40px;width:21px;height:22px'> <?= $data['pengirim'] == "nasabah" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                                <!--[if gte vml 1]><v:rect
...
position:absolute;z-index:2;left:771px;top:40px;width:21px;height:22px'><?= $data['pengirim'] == "non nasabah" ? "&#10004;" : ""  ?></span>
 ...
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:256px;top:109px;width:19px;height:18px'><?= $data['transaksi'] == "sknbi" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                            </p>
                            <p>
                                <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:158px;top:109px;width:19px;height:18px'><?= $data['transaksi'] == "tt" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                            </p>
                            <p>
                                <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:201px;top:110px;width:19px;height:18px'><?= $data['transaksi'] == "rtgs" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                            </p>
                            <p>
                                <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:86px;top:111px;width:19px;height:18px'><?= $data['transaksi'] == "setoran" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                                <!--[if gte vml 1]><v:rect
 id="_x0000_s1030" style='position:absolute;left:237.75pt;top:81.75pt;width:12.75pt;
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:453px;top:75px;width:19px;height:18px'><?= $data['transaksi'] == "kliring" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                            </p>
                            <p>
                                <!--[if gte vml 1]><v:rect
 ...
 height:12pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:vglayout;
position:absolute;z-index:1;left:431px;top:108px;width:19px;height:18px'><?= $data['transaksi'] == "bank" ? "&#10004;" : ""  ?></span>
                                <![endif]>
                            </p>
                            <p>
                                <!--[if gte vml 1]><v:rect
...
height:19px'><?= $data['status_penduduk2'] == "bukan penduduk" ? "&#10004;" : ""  ?></span>
 ...
 height:58.5pt;z-index:1'/><![endif]-->
                                <![if !vml]><span style='mso-ignore:
vglayout;position:absolute;z-index:1;left:150px;top:187px;width:370px;
